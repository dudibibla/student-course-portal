    ...
    public CommandLineRunner initData(UserRepository userRepository, CourseRepository courseRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            if (userRepository.count() == 0) {
                ...
                // Create Admin
                User admin = new User("System Admin", "admin@portal.com", passwordEncoder.encode("admin123"), Role.ADMIN);
                userRepository.save(admin);

                // Create Teachers
                User teacher1 = new User("Dr. Alan Turing", "turing@portal.com", passwordEncoder.encode("password"), Role.TEACHER);
                userRepository.save(teacher1);

                User teacher2 = new User("Prof. Grace Hopper", "hopper@portal.com", passwordEncoder.encode("password"), Role.TEACHER);
                userRepository.save(teacher2);

                User teacher3 = new User("Joan Clarke", "clarke@portal.com", passwordEncoder.encode("password"), Role.TEACHER);
                userRepository.save(teacher3);

                User teacher4 = new User("Gordon Welchman", "welchman@portal.com", passwordEncoder.encode("password"), Role.TEACHER);
                userRepository.save(teacher4);

                // Create Students (Classic Cryptography & CS placeholder names)
                User student1 = new User("David", "david@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student1);

                User student2 = new User("Alice Smith", "alice@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student2);

                User student3 = new User("Bob Jones", "bob@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student3);

                User student4 = new User("Eve Eavesdropper", "eve@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student4);

                User student5 = new User("Mallory Attacker", "mallory@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student5);

                User student6 = new User("Trent Trusted", "trent@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student6);

                User student7 = new User("Carol Communicator", "carol@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student7);

                User student8 = new User("Dave Data", "dave@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student8);

                User student9 = new User("Craig Cracker", "craig@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student9);

                User student10 = new User("Peggy Prover", "peggy@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student10);

                User student11 = new User("Victor Verifier", "victor@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student11);

                User student12 = new User("Sybil Pseudonym", "sybil@student.com", passwordEncoder.encode("password"), Role.STUDENT);
                userRepository.save(student12);

                User student13 = new User("Judy Judge", "judy@student.com", passwordEncoder.encode("password"), Role.STUDENT);
